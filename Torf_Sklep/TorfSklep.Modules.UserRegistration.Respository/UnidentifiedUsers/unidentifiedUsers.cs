   ...
   public class UnidentifiedUsers : IUniedetifiedUsers
    {
        ...
        public string undentified_reason { get; }
        public DateTime undentified_date { get; }

        public UnidentifiedUsers(int user_id, string reason, DateTime dateOfOccurrence)
        {
            this.user_id = user_id;
            this.undentified_reason = reason;
        ...
        public void AddUnidentifiedUser(int user_id, string reason, DateTime dateReason)
        {
            throw new NotImplementedException();
        }
